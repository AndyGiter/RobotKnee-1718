        ...
        while (opModeIsActive()){
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (vuMark.equals(RelicRecoveryVuMark.LEFT)) {
                    ...
                    BackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    BackRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    FrontLeft.setTargetPosition(26*TickToInch);
                    FrontRight.setTargetPosition(26*TickToInch);
                    BackLeft.setTargetPosition(26*TickToInch);
                    BackRight.setTargetPosition(26*TickToInch);
                    FrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    FrontRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    ...
                    BackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    BackRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    FrontLeft.setTargetPosition(19*TickToInch);
                    FrontRight.setTargetPosition(19*TickToInch);
                    BackLeft.setTargetPosition(19*TickToInch);
                    BackRight.setTargetPosition(19*TickToInch);
                    FrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    FrontRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    ...
                    BackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    BackRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    FrontLeft.setTargetPosition(17*TickToInch);
                    FrontRight.setTargetPosition(17*TickToInch);
                    BackLeft.setTargetPosition(17*TickToInch);
                    BackRight.setTargetPosition(17*TickToInch);
                    FrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    FrontRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    BackRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
